      ...
      <div className="auth-container">
        ...
        <div className="auth-form">
          <div className="connection-section">
            <button 
              className={`connection-btn ${githubConnected ? 'connected' : ''}`}
            ...
            >
              ...
              <div className="btn-content">
                <span className="btn-title">
                  {githubConnected ? 'GitHub Connected' : 'Connect with GitHub'}
                </span>
                <span className="btn-subtitle">
                  {githubConnected ? 'Successfully connected to your GitHub account' : 'Connect to access your repositories'}
                </span>
              </div>
              {githubConnected && (
            ...
            >
              ...
              <div className="btn-content">
                <span className="btn-title">
                  {metamaskConnected ? 'MetaMask Connected' : 'Connect to MetaMask'}
                </span>
                <span className="btn-subtitle">
